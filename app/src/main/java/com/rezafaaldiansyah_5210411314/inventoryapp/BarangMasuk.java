...
public class BarangMasuk extends AppCompatActivity {
    ...
    public static final String url = "http://192.168.26.36/AutoDiesel/insert_masuk.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutInputCatatan.setOnClickListener(v -> {
            Intent intent = new Intent(BarangMasuk.this, CatatanActivity.class);
    ...
    void inputData() {
        ...
        String jumlah_masuk = etStockBarang.getText().toString();
